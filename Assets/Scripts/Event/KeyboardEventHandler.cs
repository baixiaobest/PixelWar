...
public class KeyboardEventHandler : MonoBehaviour {
	...
	public static event KeyboardCallback Is_Running;

	public static event KeyboardCallback No_Movement;

	public static event KeyboardCallback Fire1_Key;
	public static event KeyboardCallback Fire1_Keydown;
	public static event KeyboardCallback Fire1_Keyup;
	public static event KeyboardCallback Fire2_Key;
	public static event KeyboardCallback Fire2_Keydown;
	public static event KeyboardCallback Fire2_Keyup;

	public static event KeyboardCallback Debug_Click;

	public static event KeyboardCallback Arrow_Forward;
	public static event KeyboardCallback Arrow_Backward;
	public static event KeyboardCallback Arrow_Left;
	public static event KeyboardCallback Arrow_Right;

	public static event KeyboardCallback Slot_1;
	public static event KeyboardCallback Slot_2;
	public static event KeyboardCallback Slot_3;
	public static event KeyboardCallback Slot_4;

	public static event MouseMovementCallBack MouseMovement;
